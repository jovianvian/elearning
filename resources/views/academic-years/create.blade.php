@extends('layouts.app', ['title' => __('ui.create_academic_year')])

@section('content')
    <x-ui.page-header :title="__('ui.create_academic_year')" :subtitle="__('ui.academic_year_management_subtitle')">
        <x-slot:actions>
    ...
    <div class="tera-card">
        <div class="tera-card-body">
            <form method="POST" action="{{ route('super-admin.academic-years.store') }}" class="space-y-4" data-submit-lock="true">
